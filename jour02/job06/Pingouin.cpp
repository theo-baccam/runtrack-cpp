...
std::list<std::string> Pingouin::lieuxDeRencontre = {"lac", "glacier"};
...
void Pingouin::ajouterLieuDeRencontre(std::string nom) {
    Pingouin::lieuxDeRencontre.push_back(nom);
}

void Pingouin::supprimerLieuDeRencontre(std::string nom) {
    auto removeKey = std::find(
        Pingouin::lieuxDeRencontre.begin(),
        Pingouin::lieuxDeRencontre.end(),
        nom
    );
    Pingouin::lieuxDeRencontre.erase(removeKey);
}